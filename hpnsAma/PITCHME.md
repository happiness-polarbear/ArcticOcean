...
<span style="font-size:0.8em; color:gray; display: block; text-align: left;">date: 2017/07/14 | author: ama</span>
...
まだ、スライド作成に時間かかっていますが、慣れていければ良いなと思います。
...
本来だと１人で運用していけば良いのですが、複数人での運用方法を考えてみようと思います。
...
- デフォルトのままでは見難かったので、PITCHME.cssを利用して、オリジナルのスライドを模索する必要がある
- マークダウンなので、慣れれば早くスライド作成ができそう
